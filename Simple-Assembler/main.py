...
if isLabelValid(lbl_called,lbl_declared,lbl_inst,ls_instructions2,alphanum,lbl_declared2,var_declared2) == -1:
    error_tracker.append(f'ERROR (Label): Invalid label name')
    VALID = False
if isLabelValid(lbl_called,lbl_declared,lbl_inst,ls_instructions2,alphanum,lbl_declared2,var_declared2) == -2:
    error_tracker.append(f'ERROR (Label): Invalid label instruction')
    VALID = False
if isLabelValid(lbl_called,lbl_declared,lbl_inst,ls_instructions2,alphanum,lbl_declared2,var_declared2) == -3:
    error_tracker.append(f'ERROR (Label): Invalid label called')
    VALID = False
if isLabelValid(lbl_called,lbl_declared,lbl_inst,ls_instructions2,alphanum,lbl_declared2,var_declared2) == -4:
    error_tracker.append(f'ERROR (Label): Label name is the same as an instruction')
    VALID = False
if isLabelValid(lbl_called,lbl_declared,lbl_inst,ls_instructions2,alphanum,lbl_declared2,var_declared2) == -5:
